...
function Cart(){
    ...
    return(
        products.length ? 
        <div className="container mx-auto lg: w-1/2 w-full pb-24 px-20">
          <h1 className="my-12 font-bold">Cart Items</h1>
           <ul> 
            {
                products.map(product => {
                    return(
                        ...
                        <button onClick = {()=>{handleDelete(product._id)}}className="bg-red-500 rounded-full px-4 py-2 leading-none text-white">Delete</button>
                        </div>
                    </li>
                    )
                })
           ...
           <hr  className="my-6"/>
            ...
            <div className="text-right mt-6">
             <button  onClick = {handleOrderNow} className="px-4 py-2 rounded-full bg-yellow-500 leading-none">Order Now</button>
            </div>
